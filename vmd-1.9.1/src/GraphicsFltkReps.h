 ...
 *      $Revision: 1.126 $       $Date: 2011/12/02 23:10:36 $
 *
 ***************************************************************************
 * DESCRIPTION:
...
public:
  ...
  void resolution_changed() {
    ...
    float density = 0.5f;
    if (val > 3.0f) {
      density = 30.0f*(val-3.0f)+6.0f*powf((val-3.0f),2)+10.0f*pow(val-3.0f,0.5f)+23.0f;
    } else if (val > 1) {
      density = 254.83f * expf(-1.018f * val) - 
                5071.0f * powf(val, -0.0189) + 4980.0f;
    } else {
      density = val;
    }
