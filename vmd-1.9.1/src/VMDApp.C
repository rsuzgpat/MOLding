 ...
 *      $Revision: 1.492 $      $Date: 2012/01/28 19:28:18 $
 *
 ***************************************************************************/
...
int VMDApp::VMDinit(int argc, char **argv, const char *displaytype, 
  ...
  uiText = new UIText(this, strcmp(displaytype, "TEXT") != 0); // text user interface
#endif
  ...
  if (uiText == NULL)
    uiText = new UIText(this, display->supports_gui()); // text user interface
  uiText->On();
