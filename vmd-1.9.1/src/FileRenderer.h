 ...
 *	$Revision: 1.114 $	$Date: 2011/12/05 08:05:51 $
 *
 ***************************************************************************
 * DESCRIPTION:
 *
...
protected:
  ...
  virtual void trimesh_n3v3(float *n, float *v, int numfacets) { 
    int i;
  ...
  /// triangle mesh built from a vertex array
  virtual void trimesh_c3n3v3(float *c, float *n, float *v, int numfacets) { 
    int i;
    for (i=0; i<numfacets*9; i+=9) {
      tricolor(v + i    ,
               v + i + 3, 
