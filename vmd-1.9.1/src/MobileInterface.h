 ...
 *	$Revision: 1.5 $	$Date: 2012/01/28 19:28:17 $
 *
 ***************************************************************************
 * DESCRIPTION:
 *
...
private:
  ...
  bool isInControl(JString* nick, JString* ip, const int packtype);
...
int set_activeClient(const char *nick, const char *ip);
  ...
  int  addNewClient(JString* nick,  JString* ip, const bool active);
